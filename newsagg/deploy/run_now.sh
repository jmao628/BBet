...
echo "▶ 1/8 scrape  — refresh SA universe…"
...
echo "▶ 6/8 supplychain (needs OPENAI_API_KEY; skipped if unset)…"
"$PY" -m newsagg.supplychain || echo "  (supplychain skipped/failed; keeping existing maps)"
echo "▶ 7/8 catalyst (needs OPENAI_API_KEY; new focus names + stale re-fetch)…"
...
echo "▶ 8/8 conviction (needs OPENAI_API_KEY; management-tone read of shortlist survivors)…"
